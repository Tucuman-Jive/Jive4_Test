...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANNELMEMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHANNELMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHANNELMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHANNELMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHANNELMEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHANNELMEMBER actions', async () => {
      const expectedActions = [
        {
