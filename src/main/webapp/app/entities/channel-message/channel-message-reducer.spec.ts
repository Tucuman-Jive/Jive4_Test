...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHANNELMESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHANNELMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHANNELMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHANNELMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHANNELMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHANNELMESSAGE actions', async () => {
      const expectedActions = [
        {
