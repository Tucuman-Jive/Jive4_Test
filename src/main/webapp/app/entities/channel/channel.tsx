  ...
  return (
    <div>
      <h2 id="channel-heading" data-cy="ChannelHeading">
        <Translate contentKey="jiveApp.channel.home.title">Channels</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jiveApp.channel.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/channel/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiveApp.channel.home.createLabel">Create new Channel</Translate>
          </Link>
        </div>
      </h2>
        ...
        {channelList && channelList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jiveApp.channel.id">ID</Translate>
                </th>
                <th>
                ...
                <th>
                  <Translate contentKey="jiveApp.channel.updatedAt">Updated At</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jiveApp.channel.home.notFound">No Channels found</Translate>
            </div>
          )
        )}
      </div>
