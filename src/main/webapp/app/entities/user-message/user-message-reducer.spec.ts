...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMESSAGE actions', async () => {
      const expectedActions = [
        {
