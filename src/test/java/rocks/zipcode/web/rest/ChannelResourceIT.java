...
class ChannelResourceIT {
    ...
    public static Channel createEntity(EntityManager em) {
        Channel channel = new Channel().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).updatedAt(DEFAULT_UPDATED_AT);
        return channel;
    }
    ...
    public static Channel createUpdatedEntity(EntityManager em) {
        Channel channel = new Channel().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).updatedAt(UPDATED_UPDATED_AT);
        return channel;
    }
    ...
    void putExistingChannel() throws Exception {
        ...
        updatedChannel.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).updatedAt(UPDATED_UPDATED_AT);
    ...
    void fullUpdateChannelWithPatch() throws Exception {
        ...
        partialUpdatedChannel.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).updatedAt(UPDATED_UPDATED_AT);
